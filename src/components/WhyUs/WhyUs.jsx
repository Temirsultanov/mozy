...
const reasons = [
    ...
    },
    {
        ...
        text: ["Дарим 1 год бесплатной поддержки проекта после релиза.", "Исправим баги (если появятся), поможем запустить проект на ваших серверах, проследим за работой связанных с проектом сервисов"]
    },
].map(reason => {
