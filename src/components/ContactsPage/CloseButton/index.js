...
import {closeButton} from "./style.module.scss";

const CloseButton = ({className, setContactsHiddenState}) => {
    function closeContacts() {
        setContactsHiddenState(true);
    };
    return (
        <button className={`${closeButton} ${className}`} onClick={closeContacts}>
